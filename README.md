...
<ul>
  ...
  <li><strong>Backend:</strong> Flask, Node.js (learning)</li>
  <li><strong>Database:</strong> MySQL, MongoDB (learning)</li>
  <li><strong>Tools:</strong> Git, VS Code, Postman, Insomnia, Figma, PowerBI</li>
</ul>
